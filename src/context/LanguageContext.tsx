...
const translations = {
  bg: {
    ...
    loginErrorInvalidCredentials: 'Грешен и-мейл или парола.',
    loginErrorAccountDeactivated: 'Вашият акаунт е деактивиран от администратор.',
    loginErrorEmailNotConfirmed: 'Трябва да потвърдите имейла си, преди да се впишете. Проверете пощата си.',
    loginErrorGeneric: 'Възникна неочаквана грешка. Моля, опитайте отново.',
    activate: 'Активирай',
  ...
  en: {
    ...
    loginErrorAccountDeactivated: 'Your account has been deactivated by an administrator.',
    loginErrorEmailNotConfirmed: 'You must confirm your email before signing in. Please check your inbox.',
